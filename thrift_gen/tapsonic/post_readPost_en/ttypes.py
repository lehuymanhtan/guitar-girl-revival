...
class readPost(object):
    ...
    def __init__(self, call = None, data = None,):
        self.call = call
        self.data = data
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('readPost')
...
class readPostRetDataInfo(object):
    """
    Attributes:
     - idx
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('readPostRetDataInfo')
...
class readPostReturn(object):
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('readPostReturn')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(readPost)
readPost.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'call', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'data', [tapsonic.general.ttypes.PostDataInfo, None], None, ),  # 2
)
all_structs.append(readPostRetDataInfo)
readPostRetDataInfo.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'idx', None, None, ),  # 1
)
all_structs.append(readPostReturn)
readPostReturn.thrift_spec = (
    None,  # 0
    ...
    (4, TType.STRUCT, 'data', [readPostRetDataInfo, None], None, ),  # 4
    None,  # 5
