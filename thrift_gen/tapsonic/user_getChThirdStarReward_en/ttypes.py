...
getChThirdStarRewardRetDataInfo.thrift_spec = (
    ...
    (3, TType.STRUCT, 'user_ap', [tapsonic.general.ttypes.UserApData, None], None, ),  # 3
    (4, TType.LIST, 'reward_data', (TType.STRUCT, [tapsonic.general.ttypes.retReward, None], False), None, ),  # 4
)
