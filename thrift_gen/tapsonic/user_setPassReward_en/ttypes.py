...
class setPassRewardDataInfo(object):
    """
    Attributes:
     - u_seq
     - u_id
    ...
    def __init__(self, u_seq = None, u_id = None, uuid = None, device_uuid = None, group = None, step = None, type = None, i_Version = None,):
        self.u_seq = u_seq
        self.u_id = u_id
        self.uuid = uuid
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('setPassRewardDataInfo')
        ...
        if self.group is not None:
            oprot.writeFieldBegin('group', TType.I32, 5)
            oprot.writeI32(self.group)
            oprot.writeFieldEnd()
        if self.step is not None:
            oprot.writeFieldBegin('step', TType.I32, 6)
        ...
        if self.i_Version is not None:
            oprot.writeFieldBegin('i_Version', TType.I32, 8)
...
class setPassReward(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = setPassRewardDataInfo()
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setPassReward')
...
class setPassRewardRetDataInfo(object):
    ...
    def __init__(self, subscribe_pass_reward = None, reward_data = None,):
        self.subscribe_pass_reward = subscribe_pass_reward
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setPassRewardRetDataInfo')
        if self.subscribe_pass_reward is not None:
            oprot.writeFieldBegin('subscribe_pass_reward', TType.STRUCT, 1)
            self.subscribe_pass_reward.write(oprot)
            oprot.writeFieldEnd()
        if self.reward_data is not None:
            oprot.writeFieldBegin('reward_data', TType.LIST, 2)
...
class setPassRewardReturn(object):
    """
    Attributes:
     - error
     - server_time
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = setPassRewardRetDataInfo()
                    self.data.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setPassRewardReturn')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(setPassRewardDataInfo)
setPassRewardDataInfo.thrift_spec = (
    None,  # 0
    ...
    (5, TType.I32, 'group', None, None, ),  # 5
    (6, TType.I32, 'step', None, None, ),  # 6
    (7, TType.I16, 'type', None, None, ),  # 7
    (8, TType.I32, 'i_Version', None, None, ),  # 8
)
all_structs.append(setPassReward)
setPassReward.thrift_spec = (
    None,  # 0
