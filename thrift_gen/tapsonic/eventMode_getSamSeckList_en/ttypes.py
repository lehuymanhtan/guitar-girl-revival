...
class getSamSeckListDataInfo(object):
    """
    Attributes:
     - u_seq
     - u_id
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('getSamSeckListDataInfo')
...
class getSamSeckList(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = getSamSeckListDataInfo()
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getSamSeckList')
...
class rewardListData(object):
    ...
    def __init__(self, i_id = None, i_RewardType = None, i_RewardId = None, d_RewardQuantity = None,):
        self.i_id = i_id
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('rewardListData')
        ...
        if self.d_RewardQuantity is not None:
            oprot.writeFieldBegin('d_RewardQuantity', TType.DOUBLE, 4)
...
class getSamSeckListRetDataInfo(object):
    """
    Attributes:
     - event_type
     - rewardList
    ...
    def __init__(self, event_type = None, rewardList = None,):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i4 in range(_size0):
                        _elem5 = rewardListData()
                        _elem5.read(iprot)
                        self.rewardList.append(_elem5)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getSamSeckListRetDataInfo')
        if self.event_type is not None:
            oprot.writeFieldBegin('event_type', TType.STRING, 1)
            oprot.writeString(self.event_type.encode('utf-8') if sys.version_info[0] == 2 else self.event_type)
            oprot.writeFieldEnd()
        if self.rewardList is not None:
            oprot.writeFieldBegin('rewardList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.rewardList))
            for iter6 in self.rewardList:
                iter6.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class getSamSeckListReturn(object):
    """
    Attributes:
     - error
     - server_time
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = getSamSeckListRetDataInfo()
                    self.data.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getSamSeckListReturn')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getSamSeckListDataInfo)
getSamSeckListDataInfo.thrift_spec = (
    None,  # 0
...
all_structs.append(getSamSeckList)
getSamSeckList.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'call', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'data', [getSamSeckListDataInfo, None], None, ),  # 2
    (3, TType.STRUCT, 'common_data', [tapsonic.common.ttypes.paramData, None], None, ),  # 3
)
all_structs.append(rewardListData)
rewardListData.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'i_id', None, None, ),  # 1
    (2, TType.I32, 'i_RewardType', None, None, ),  # 2
    (3, TType.I32, 'i_RewardId', None, None, ),  # 3
    (4, TType.DOUBLE, 'd_RewardQuantity', None, None, ),  # 4
)
all_structs.append(getSamSeckListRetDataInfo)
getSamSeckListRetDataInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'event_type', 'UTF8', None, ),  # 1
    (2, TType.LIST, 'rewardList', (TType.STRUCT, [rewardListData, None], False), None, ),  # 2
)
all_structs.append(getSamSeckListReturn)
getSamSeckListReturn.thrift_spec = (
    None,  # 0
    ...
    (5, TType.STRUCT, 'data', [getSamSeckListRetDataInfo, None], None, ),  # 5
