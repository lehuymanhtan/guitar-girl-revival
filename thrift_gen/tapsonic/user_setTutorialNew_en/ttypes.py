...
class setTutorialNewDataInfo(object):
    """
    Attributes:
     - u_seq
     - u_id
    ...
    def __init__(self, u_seq = None, u_id = None, uuid = None, device_uuid = None, i_ids = None,):
        self.u_seq = u_seq
        self.u_id = u_id
        self.uuid = uuid
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('setTutorialNewDataInfo')
...
class setTutorialNew(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = setTutorialNewDataInfo()
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setTutorialNew')
...
class setTutorialNewRetDataInfo(object):
    """
    Attributes:
     - u_seq
     - tutorial
    ...
    def __init__(self, u_seq = None, tutorial = None,):
        self.u_seq = u_seq
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i11 in range(_size7):
                        _elem12 = tapsonic.general.ttypes.UserTutorial()
                        _elem12.read(iprot)
                        self.tutorial.append(_elem12)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setTutorialNewRetDataInfo')
        if self.u_seq is not None:
            oprot.writeFieldBegin('u_seq', TType.I32, 1)
            oprot.writeI32(self.u_seq)
            oprot.writeFieldEnd()
        if self.tutorial is not None:
            oprot.writeFieldBegin('tutorial', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.tutorial))
            for iter13 in self.tutorial:
                iter13.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class setTutorialNewReturn(object):
    """
    Attributes:
     - error
     - server_time
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = setTutorialNewRetDataInfo()
                    self.data.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setTutorialNewReturn')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(setTutorialNewDataInfo)
setTutorialNewDataInfo.thrift_spec = (
    None,  # 0
...
all_structs.append(setTutorialNew)
setTutorialNew.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'call', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'data', [setTutorialNewDataInfo, None], None, ),  # 2
    (3, TType.STRUCT, 'common_data', [tapsonic.general.ttypes.paramData, None], None, ),  # 3
)
all_structs.append(setTutorialNewRetDataInfo)
setTutorialNewRetDataInfo.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'u_seq', None, None, ),  # 1
    (2, TType.LIST, 'tutorial', (TType.STRUCT, [tapsonic.general.ttypes.UserTutorial, None], False), None, ),  # 2
)
all_structs.append(setTutorialNewReturn)
setTutorialNewReturn.thrift_spec = (
    None,  # 0
    ...
    (5, TType.STRUCT, 'data', [setTutorialNewRetDataInfo, None], None, ),  # 5
