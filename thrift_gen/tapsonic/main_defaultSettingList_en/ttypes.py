...
class defaultSettingListDataInfo(object):
    """
    Attributes:
     - device_uuid
     - os
    ...
    def __init__(self, device_uuid = None, os = None,):
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('defaultSettingListDataInfo')
...
class defaultSettingList(object):
    """
    Attributes:
     - call
     - data
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = defaultSettingListDataInfo()
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('defaultSettingList')
...
class defaultSettingDataList(object):
    """
    Attributes:
     - setting_key
     - setting_value
    ...
    def __init__(self, setting_key = None, setting_value = None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.setting_key = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
                    self.setting_value = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('defaultSettingDataList')
        if self.setting_key is not None:
            oprot.writeFieldBegin('setting_key', TType.STRING, 1)
            oprot.writeString(self.setting_key.encode('utf-8') if sys.version_info[0] == 2 else self.setting_key)
            oprot.writeFieldEnd()
        if self.setting_value is not None:
            oprot.writeFieldBegin('setting_value', TType.STRING, 2)
            oprot.writeString(self.setting_value.encode('utf-8') if sys.version_info[0] == 2 else self.setting_value)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class defaultSettingListRetDataInfo(object):
    """
    Attributes:
     - status
     - setting_list
    ...
    def __init__(self, status = None, setting_list = None,):
        self.status = status
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i4 in range(_size0):
                        _elem5 = defaultSettingDataList()
                        _elem5.read(iprot)
                        self.setting_list.append(_elem5)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('defaultSettingListRetDataInfo')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRING, 1)
            oprot.writeString(self.status.encode('utf-8') if sys.version_info[0] == 2 else self.status)
            oprot.writeFieldEnd()
        if self.setting_list is not None:
            oprot.writeFieldBegin('setting_list', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.setting_list))
            for iter6 in self.setting_list:
                iter6.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class defaultSettingListReturn(object):
    """
    Attributes:
     - error
     - server_time
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = defaultSettingListRetDataInfo()
                    self.data.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('defaultSettingListReturn')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(defaultSettingListDataInfo)
defaultSettingListDataInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'device_uuid', 'UTF8', None, ),  # 1
    (2, TType.I16, 'os', None, None, ),  # 2
)
all_structs.append(defaultSettingList)
defaultSettingList.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'call', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'data', [defaultSettingListDataInfo, None], None, ),  # 2
    (3, TType.STRUCT, 'common_data', [tapsonic.common.ttypes.paramData, None], None, ),  # 3
)
all_structs.append(defaultSettingDataList)
defaultSettingDataList.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'setting_key', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'setting_value', 'UTF8', None, ),  # 2
)
all_structs.append(defaultSettingListRetDataInfo)
defaultSettingListRetDataInfo.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'status', 'UTF8', None, ),  # 1
    (2, TType.LIST, 'setting_list', (TType.STRUCT, [defaultSettingDataList, None], False), None, ),  # 2
)
all_structs.append(defaultSettingListReturn)
defaultSettingListReturn.thrift_spec = (
    None,  # 0
    ...
    (5, TType.STRUCT, 'data', [defaultSettingListRetDataInfo, None], None, ),  # 5
