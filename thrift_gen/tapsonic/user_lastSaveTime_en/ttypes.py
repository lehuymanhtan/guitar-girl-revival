...
class lastSaveTimeDataInfo(object):
    """
    Attributes:
     - u_seq
     - u_id
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('lastSaveTimeDataInfo')
...
class lastSaveTime(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = lastSaveTimeDataInfo()
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('lastSaveTime')
...
class lastSaveTimeRetDataInfo(object):
    """
    Attributes:
     - last_save_time
     - device_uuid
    ...
    def __init__(self, last_save_time = None, device_uuid = None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I64:
                    self.last_save_time = iprot.readI64()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRING:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('lastSaveTimeRetDataInfo')
        if self.last_save_time is not None:
            oprot.writeFieldBegin('last_save_time', TType.I64, 1)
            oprot.writeI64(self.last_save_time)
            oprot.writeFieldEnd()
        if self.device_uuid is not None:
...
class lastSaveTimeReturn(object):
    """
    Attributes:
     - error
     - server_time
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = lastSaveTimeRetDataInfo()
                    self.data.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('lastSaveTimeReturn')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(lastSaveTimeDataInfo)
lastSaveTimeDataInfo.thrift_spec = (
    None,  # 0
...
all_structs.append(lastSaveTime)
lastSaveTime.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'call', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'data', [lastSaveTimeDataInfo, None], None, ),  # 2
    (3, TType.STRUCT, 'common_data', [tapsonic.general.ttypes.paramData, None], None, ),  # 3
)
all_structs.append(lastSaveTimeRetDataInfo)
lastSaveTimeRetDataInfo.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'last_save_time', None, None, ),  # 1
    (2, TType.STRING, 'device_uuid', 'UTF8', None, ),  # 2
)
all_structs.append(lastSaveTimeReturn)
lastSaveTimeReturn.thrift_spec = (
    None,  # 0
    ...
    (5, TType.STRUCT, 'data', [lastSaveTimeRetDataInfo, None], None, ),  # 5
