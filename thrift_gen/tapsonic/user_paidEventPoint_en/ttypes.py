...
class paidEventPointDataInfo(object):
    """
    Attributes:
     - u_seq
     - u_id
    ...
    def __init__(self, u_seq = None, u_id = None, uuid = None, device_uuid = None, type = None, i_SubscribeID = None, i_Version = None,):
        self.u_seq = u_seq
        self.u_id = u_id
        self.uuid = uuid
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('paidEventPointDataInfo')
        ...
        if self.i_SubscribeID is not None:
            oprot.writeFieldBegin('i_SubscribeID', TType.I64, 6)
            oprot.writeI64(self.i_SubscribeID)
            oprot.writeFieldEnd()
        if self.i_Version is not None:
            oprot.writeFieldBegin('i_Version', TType.I32, 7)
...
class paidEventPoint(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = paidEventPointDataInfo()
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('paidEventPoint')
...
class paidEventPointRetDataInfo(object):
    """
    Attributes:
     - u_cp
     - u_candy
    ...
    def __init__(self, u_cp = None, u_candy = None, i_SubscribeID = None, i_Point = None, i_Version = None,):
        self.u_cp = u_cp
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('paidEventPointRetDataInfo')
        ...
        if self.u_candy is not None:
            ...
            oprot.writeFieldEnd()
        if self.i_SubscribeID is not None:
            oprot.writeFieldBegin('i_SubscribeID', TType.I64, 3)
            oprot.writeI64(self.i_SubscribeID)
            oprot.writeFieldEnd()
        if self.i_Point is not None:
            oprot.writeFieldBegin('i_Point', TType.I64, 4)
...
class paidEventPointReturn(object):
    """
    Attributes:
     - error
     - server_time
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = paidEventPointRetDataInfo()
                    self.data.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('paidEventPointReturn')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(paidEventPointDataInfo)
paidEventPointDataInfo.thrift_spec = (
    None,  # 0
    ...
    (6, TType.I64, 'i_SubscribeID', None, None, ),  # 6
    (7, TType.I32, 'i_Version', None, None, ),  # 7
)
all_structs.append(paidEventPoint)
paidEventPoint.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'call', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'data', [paidEventPointDataInfo, None], None, ),  # 2
    (3, TType.STRUCT, 'common_data', [tapsonic.general.ttypes.paramData, None], None, ),  # 3
)
all_structs.append(paidEventPointRetDataInfo)
paidEventPointRetDataInfo.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'u_cp', None, None, ),  # 1
    (2, TType.DOUBLE, 'u_candy', None, None, ),  # 2
    (3, TType.I64, 'i_SubscribeID', None, None, ),  # 3
    (4, TType.I64, 'i_Point', None, None, ),  # 4
    (5, TType.I32, 'i_Version', None, None, ),  # 5
)
all_structs.append(paidEventPointReturn)
paidEventPointReturn.thrift_spec = (
    None,  # 0
    ...
    (5, TType.STRUCT, 'data', [paidEventPointRetDataInfo, None], None, ),  # 5
