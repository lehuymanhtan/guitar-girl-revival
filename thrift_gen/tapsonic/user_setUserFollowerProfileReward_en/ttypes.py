...
class setUserFollowerProfileRewardDataInfo(object):
    """
    Attributes:
     - u_seq
     - u_id
    ...
    def __init__(self, u_seq = None, u_id = None, uuid = None, device_uuid = None, i_id = None, s_level = None,):
        self.u_seq = u_seq
        self.u_id = u_id
        self.uuid = uuid
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.s_level = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('setUserFollowerProfileRewardDataInfo')
        ...
        if self.i_id is not None:
            ...
            oprot.writeFieldEnd()
        if self.s_level is not None:
            oprot.writeFieldBegin('s_level', TType.STRING, 6)
            oprot.writeString(self.s_level.encode('utf-8') if sys.version_info[0] == 2 else self.s_level)
            oprot.writeFieldEnd()
...
class setUserFollowerProfileReward(object):
    """
    Attributes:
     - call
     - data
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = setUserFollowerProfileRewardDataInfo()
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setUserFollowerProfileReward')
...
class setUserFollowerProfileRewardRetDataInfo(object):
    """
    Attributes:
     - i_id
     - i_level
    ...
    def __init__(self, i_id = None, i_level = None, reward_data = None, user_follower_profile = None,):
        self.i_id = i_id
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setUserFollowerProfileRewardRetDataInfo')
        if self.i_id is not None:
...
class setUserFollowerProfileRewardReturn(object):
    """
    Attributes:
     - error
     - server_time
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i11 in range(_size7):
                        _elem12 = setUserFollowerProfileRewardRetDataInfo()
                        _elem12.read(iprot)
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('setUserFollowerProfileRewardReturn')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(setUserFollowerProfileRewardDataInfo)
setUserFollowerProfileRewardDataInfo.thrift_spec = (
    None,  # 0
    ...
    (6, TType.STRING, 's_level', 'UTF8', None, ),  # 6
)
all_structs.append(setUserFollowerProfileReward)
setUserFollowerProfileReward.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'call', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'data', [setUserFollowerProfileRewardDataInfo, None], None, ),  # 2
    (3, TType.STRUCT, 'common_data', [tapsonic.general.ttypes.paramData, None], None, ),  # 3
)
all_structs.append(setUserFollowerProfileRewardRetDataInfo)
setUserFollowerProfileRewardRetDataInfo.thrift_spec = (
    None,  # 0
...
all_structs.append(setUserFollowerProfileRewardReturn)
setUserFollowerProfileRewardReturn.thrift_spec = (
    None,  # 0
    ...
    (5, TType.LIST, 'data', (TType.STRUCT, [setUserFollowerProfileRewardRetDataInfo, None], False), None, ),  # 5
