...
class getSamSeckRewardDataInfo(object):
    """
    Attributes:
     - u_seq
     - u_id
    ...
    def __init__(self, u_seq = None, u_id = None, uuid = None, device_uuid = None, i_id = None,):
        self.u_seq = u_seq
        self.u_id = u_id
        self.uuid = uuid
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin('getSamSeckRewardDataInfo')
...
class getSamSeckReward(object):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = getSamSeckRewardDataInfo()
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getSamSeckReward')
...
class getSamSeckRewardRetDataInfo(object):
    """
    Attributes:
     - step
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getSamSeckRewardRetDataInfo')
        if self.step is not None:
            oprot.writeFieldBegin('step', TType.I16, 1)
            oprot.writeI16(self.step)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class getSamSeckRewardReturn(object):
    """
    Attributes:
     - error
     - server_time
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.data = getSamSeckRewardRetDataInfo()
                    self.data.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getSamSeckRewardReturn')
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getSamSeckRewardDataInfo)
getSamSeckRewardDataInfo.thrift_spec = (
    None,  # 0
...
all_structs.append(getSamSeckReward)
getSamSeckReward.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'call', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'data', [getSamSeckRewardDataInfo, None], None, ),  # 2
    (3, TType.STRUCT, 'common_data', [tapsonic.common.ttypes.paramData, None], None, ),  # 3
)
all_structs.append(getSamSeckRewardRetDataInfo)
getSamSeckRewardRetDataInfo.thrift_spec = (
    None,  # 0
    (1, TType.I16, 'step', None, None, ),  # 1
)
all_structs.append(getSamSeckRewardReturn)
getSamSeckRewardReturn.thrift_spec = (
    None,  # 0
    ...
    (5, TType.STRUCT, 'data', [getSamSeckRewardRetDataInfo, None], None, ),  # 5
